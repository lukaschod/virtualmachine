...
public:
	...
	void ReadFile(CentralProcessingUnit* core, uint32_t fileHandle, uint32_t address, size_t size = sizeof(uint32_t));
	void WriteFile(CentralProcessingUnit* core, uint32_t fileHandle, uint32_t address, size_t size = sizeof(uint32_t));
