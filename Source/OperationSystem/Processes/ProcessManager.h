...
public:
	...
	void CreateProcessUser(CentralProcessingUnitCore* core, uint32_t pathToFileAddress, ProcessKernelInstructions callback);
	void DestroyProcessUser(CentralProcessingUnitCore* core, uint32_t processHandle, ProcessKernelInstructions callback);
